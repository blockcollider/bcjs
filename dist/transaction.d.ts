...
export declare const createFeedTransaction: (spendableWalletOutPointObjs: coreProtobuf.WalletOutPoint.AsObject[], olAddress: string, olPrivateKeyHex: string, feedAddress: string, olAmount: string, olUnit: string, addDefaultFee?: boolean) => coreProtobuf.Transaction;
