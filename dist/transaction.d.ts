...
export declare const createNRGTransferTransaction: (spendableWalletOutPointObjs: coreProtobuf.WalletOutPoint.AsObject[], fromAddress: string, privateKeyHex: string, toAddress: string, transferAmountNRG: string, txFeeNRG: string, addDefaultFee: boolean | undefined, bcClient: RpcClient) => Promise<coreProtobuf.Transaction>;
export declare const createFeedTransaction: (spendableWalletOutPointObjs: coreProtobuf.WalletOutPoint.AsObject[], olAddress: string, olPrivateKeyHex: string, feedAddress: string, olAmount: string, olUnit: string, addDefaultFee: boolean | undefined, bcClient: RpcClient) => Promise<coreProtobuf.Transaction>;
...
export declare const createOverlineChannelMessage: (spendableWalletOutPointObjs: coreProtobuf.WalletOutPoint.AsObject[], fromAddress: string, privateKeyHex: string, toAddress: string, transferAmountNRG: string, txFeeNRG: string, addDefaultFee: boolean | undefined, bcClient: RpcClient) => Promise<coreProtobuf.Transaction>;
...
}, bcAddress: string, bcPrivateKeyHex: string, collateralizedNrg: string, additionalTxFee: string, addDefaultFee: boolean | undefined, bcClient: RpcClient) => Promise<coreProtobuf.Transaction>;
