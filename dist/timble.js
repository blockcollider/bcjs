...
class TimbleScript {
    ...
    static createMakerLockScript(shiftMaker, shiftTaker, depositLength, settleLength, sendsFromChain, receivesToChain, sendsFromAddress, receivesToAddress, sendsUnit, receivesUnit, fixedUnitFee, bcAddress) {
        ...
        let unlockMonadScript = ['OP_BLAKE2BL', doubleHashedBcAddress, 'OP_EQUALVERIFY', 'OP_CHECKSIGVERIFY'];
        ...
        const script = fixedUnitFee === '' ?
            [
                ...
                ['OP_2', 'OP_IFEQ', 'OP_TAKERPAIR', '2', '0', 'OP_MINUNITVALUE', 'OP_ENDIFEQ'],
                ...
                ['OP_3', 'OP_IFEQ', 'OP_MONAD'], unlockMonadScript, ['OP_ENDMONAD', 'OP_ENDIFEQ'],
            ...
            [
                ...
                ['OP_2', 'OP_IFEQ', 'OP_TAKERPAIR', '1', fixedUnitFee, 'OP_MINUNITVALUE', 'OP_MONAD'], unlockMonadScript, ['OP_ENDMONAD', 'OP_ENDIFEQ'],
                // between deposit and settlement - return
                ['OP_3', 'OP_IFEQ', 'OP_RETURN', 'OP_ENDIFEQ'],
                //after settlement period - calculate who sent their asset
                ['OP_DROP'], makerCollArgs, ['OP_MAKERCOLL'],
                ...
                ['OP_5', 'OP_IFEQ', 'OP_MONAD'], unlockMonadScript, ['OP_ENDMONAD', 'OP_ENDIFEQ'],
            ];
        console.log({ script });
