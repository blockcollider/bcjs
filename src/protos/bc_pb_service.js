...
Bc.PlaceMakerNrgOrder = {
  methodName: "PlaceMakerNrgOrder",
  service: Bc,
  requestStream: false,
  responseStream: false,
...
BcClient.prototype.placeMakerNrgOrder = function placeMakerNrgOrder(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Bc.PlaceMakerNrgOrder, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
